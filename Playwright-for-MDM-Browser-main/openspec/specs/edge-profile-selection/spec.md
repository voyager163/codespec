# Edge Profile Selection Specification

## Purpose
TBD - Captures requirements for selecting a local Microsoft Edge profile and attaching Playwright through the Chrome DevTools Protocol endpoint.
